...
- (void)setupUI
{
    ...
    self.webView.frame = CGRectMake(0, self.navigationHeight, SCREEN_WIDTH, SCREEN_HEIGHT);
...
- (UIBarButtonItem*)customBackBarItem
{
    if (!_customBackBarItem) {
        _customBackBarItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"icon_default_back"] style:UIBarButtonItemStylePlain target:self action:@selector(customBackItemClicked)];
...
- (UIButton *)retryButton
{
    if (!_retryButton)
    {
        ...
        _retryButton.bounds = CGRectMake(0, 0, SCREEN_WIDTH - 24, 60);
        _retryButton.center = CGPointMake(CGRectGetMidX(self.view.frame), CGRectGetMidY(self.view.frame));
